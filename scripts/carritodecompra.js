...
let producto1 = new Producto(1, "Blue Lock", "1", 650, "blue-lock.jpg");
let producto2 = new Producto( 2, "Boku No Hero", "1", 600, "hero.jpg");
let producto3 = new Producto(3, "Naruto", "1", 800, "Naruto.jpg");
let producto4 = new Producto(4, "One Piece", "1", 750, "one.jpg");
let producto5 = new Producto(5, "Vinland Saga", "1", 800, "Vinland.jpg");
